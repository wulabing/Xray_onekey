...
* telegram 交流群:https://t.me/wulabing_v2ray，群主仅提供极其有限的支持，如有问题可以询问群友
### 2019-11-26
...
### 证书
> 如果你已经拥有了你所使用域名的证书文件，可以将 crt 和 key 文件命名为 v2ray.crt v2ray.key 放在 /data 目录下（若目录不存在请先建目录），请注意证书文件权限
