...
您可以使用我的 搬瓦工 AFF 购买 VPS： https://bandwagonhost.com/aff.php?aff=63939

支持通过 Telegram MugglePay 接受虚拟货币捐赠：发送 `/pay @wulabing xxx` 到 [@MugglePayBot](https://t.me/MugglePayBot) 即可，默认货币为 USDT。
